...
//	if (header.sensorID == 2) BGC
	if (header.sensorID == 240) { //D0 F0
		return 1;
	} else if (header.sensorID == 208) { //Sorting the D0-D6 Config Dump so in correct order
		return 2;
	} else if (header.sensorID == 209) { //D1
		return 3;
	} else if (header.sensorID == 210) { //D2
		return 4;
	} else if (header.sensorID == 211) { //D3
		return 5;
	} else if (header.sensorID == 212) { //D4
		return 6;
	} else if (header.sensorID == 213) { //D5
		return 7;
	} else if (header.sensorID == 214) { //D6
		return 8;
	} else {
		return 9;
        }
