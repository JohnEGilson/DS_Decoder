...
std::string logfile() {
    ...
    //std::string logfile = std::format("{:s}/log/{:04d}{:02d}{:02d}.log",DS_PATH,tm.tm_year+1900,tm.tm_mon+1,tm.tm_mday);
    std::string logfile = DS_PATH + "/log/" + std::to_string(tm.tm_year+1900) + std::to_string(tm.tm_mon+1) + std::to_string(tm.tm_mday);
