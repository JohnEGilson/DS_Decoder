...
public:
	...
	double presQ;           // Quartzdyne Pressure [dBar]
	...
	unsigned int time_sc;  // seconds since start-of-fall that this pump event STOPPED
...
public:
	...
	unsigned int version;                // packet version [0:original DS, 1: firmware after V0.1]
};
